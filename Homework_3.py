...
left_1 = [int(input("x кордината первого прямоугольника ")), int(input("y кордината первого прямоугольника "))] # Левый нижний угол 1-го прям
w_h_1 = [int(input("ширина_1 ")), int(input("высота_1 "))]
left_2 = [int(input("x кордината второго прямоугольника ")), int(input("y кордината второго прямоугольника "))] # Левый нижний угол 2-го прям
